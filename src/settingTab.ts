...
export class WereadSettingsTab extends PluginSettingTab {
  ...
  private notebookFolder(): void {
    new Setting(this.containerEl)
      ...
      .addDropdown((dropdown) => {
        ...
        return dropdown.setValue(get(settingsStore).noteLocation).onChange(async (value) => {
  ...
  private dailyNotesFolder() {
    new Setting(this.containerEl)
      ...
      .addDropdown((dropdown) => {
        ...
        return dropdown.setValue(get(settingsStore).dailyNotesLocation).onChange(async (value) => {
  ...
  private subFolderType(): void {
    new Setting(this.containerEl)
      ...
      .addDropdown((dropdown) => {
        ...
        return dropdown.setValue(get(settingsStore).subFolderType).onChange(async (value) => {
  ...
  private fileNameType(): void {
    new Setting(this.containerEl)
      ...
      .addDropdown((dropdown) => {
        ...
        return dropdown.setValue(get(settingsStore).fileNameType).onChange(async (value) => {
  ...
  private showDebugHelp() {
    ...
    info.setText('查看控制台日志: 使用以下快捷键快速打开控制台，查看本插件以及其他插件的运行日志');
